...
void readxml_fit_fithist(TString inputname, TString outputname,
...
int main(int argc, char* argv[])
{
  if(argc==9)
    {
      readxml_fit_fithist(argv[1], argv[2], argv[3], argv[4], atof(argv[5]), atof(argv[6]), atof(argv[7]), atof(argv[8]));
      return 0;
    }
  else
    {
