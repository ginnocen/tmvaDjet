			...
			TString myMethodList="")
{
  ...
  TString outfileName(Form("ROOT/TMVA.root"));
  ...
  TTree* signal = (TTree*)inputS->Get("tmvadjt");
   ...
   if (Use["CutsSA"])
      factory->BookMethod( TMVA::Types::kCuts, "CutsSA",
                           "!H:!V:FitMethod=SA:EffSel:MaxCalls=150000:KernelTemp=IncAdaptive:InitialTemp=1e+6:MinTemp=1e-6:Eps=1e-10:UseDefaultScale:VarProp[0]=FMin:VarProp[1]=FMax" );
